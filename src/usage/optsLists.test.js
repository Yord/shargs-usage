...
test('optsListsWith with wrong id uses default style for first column, but cuts the second column', () => {
  const id1 = 'test'
  const id2 = 'wrong'
  ...
  const style = {
    [id1]: [{width: 35}, {width: 30}]
  }

  const res = optsListsWith({id: id2})(opts)(style)
...
test('optsListsWith with undefined id and pad uses default id and pad', () => {
